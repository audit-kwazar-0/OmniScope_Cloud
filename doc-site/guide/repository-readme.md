...
> **Auto-generated page:** content is copied from [`README.md`](https://github.com/audit-kwazar-0/OmniScope_Cloud/blob/main/README.md) on `npm run sync-readme` / before VitePress build. Edit the **root** README, then rebuild docs.
